        ...
        <div role='document' className='modal-dialog'>
          <div className='modal-content'>
            ...
            <div className='modal-body'>
              <form action='/dashboard/ozp/store'
                name='ozp'
                id='form-ozp'
                method='POST'
                style={{ margin: 0 }}>
                ...
                <div className='form-group'>
                  ...
                  <input
                    ...
                    name='date'
                    id='ozp-date'
                    className='form-control makdoors-datepicker'
                    defaultValue={ moment().locale('ru').format('L') } />
                </div>
                <div className='form-group'>
                ...
                <div className='form-group'>
                  <label
                    htmlFor='ozp-address'
                  >Адрес доставки или номер и дата заказа на самовывоз: </label>
            ...
            <div className='modal-footer'>
              <button
                type='button'
                data-dismiss='modal'
                className='btn btn-default'>Закрыть</button>
              <button
                form='ozp'
                className='btn btn-primary btn-ozp-send'>Добавить в отчет </button>
            </div>
          </div>
        </div>
      </div>
